class VendingMachine:
    def __init__(self):
        #Start the Vending Machine with classified items
        self.items = {
            "Drinks": {
    ...
    def display_menu(self):
        # displays the codes of a menu item, name, prices, and stock of the food stuffs.
    ...
    def process_payment(self, item, quantity):
        #Check whether adequate payment has been made, along with the payment-making sure the user inserted enough money, pay the exact change.
    ...
    def run(self):
        #  If this script is run directly then call the vending_machine program.  
        ...
        # Show payment information and total transaction information
        if selected_items:
...
# Function to show user payment outside of the class within the vending machine.
